...
var paths = {
    ...
    src: {
        root:       'public_html/docs/assets',
        html:       'public_html/**/*.html',
        css:        'public_html/docs/assets/css/*.css',
        js:         'public_html/docs/assets/js/*.js',
        vendors:    'public_html/docs/assets/vendors/**/*.*',
        imgs:       'public_html/docs/assets/imgs/**/*.+(png|jpg|gif|svg)',
        scss:       'public_html/docs/assets/scss/**/*.scss'
    },
    dist: {
